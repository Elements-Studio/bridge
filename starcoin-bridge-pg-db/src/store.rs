...
use starcoin_bridge_indexer_alt_framework_store_traits as store;
use starcoin_bridge_sql_macro::sql;

use crate::model::StoredWatermark;
use crate::schema::watermarks;
use crate::{Connection, Db};

pub use starcoin_bridge_indexer_alt_framework_store_traits::Store;
