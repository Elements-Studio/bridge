// BCS-based blob storage - compatible with both Starcoin and Starcoin
// This is a simple wrapper around BCS serialization with encoding metadata
...
pub mod blob {
    ...
    impl Blob {
        // Encode a value into a Blob using BCS serialization
        ...
        // Decode a Blob into a value using BCS deserialization
        ...
        // Deserialize directly from bytes (encoding + data)
