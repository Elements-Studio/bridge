...
use sui::object::starcoin_accumulator_root_address;
...
fun create(ctx: &TxContext) {
    ...
    transfer::share_object(AccumulatorRoot {
        id: object::starcoin_accumulator_root_object_id(),
    })
}
...
public(package) fun accumulator_address<T>(address: address): address {
    ...
    dynamic_field::hash_type_and_key(starcoin_accumulator_root_address(), key)
}
