...
module Bridge::Limiter {
    ...
    const USD_VALUE_MULTIPLIER: u64 = 1000000000; // 9 DP accuracy
    ...
    fun initial_transfer_limits(): SimpleMap<BridgeRoute, u64> {
        ...
        // eth_sepolia and starcoin_testnet
        SimpleMap::add(
            &mut transfer_limits,
        ...
        SimpleMap::add(
            &mut transfer_limits,
            ChainIDs::get_route(ChainIDs::starcoin_custom(), ChainIDs::eth_custom()),
            DEFAULT_TRANSFER_LIMIT * USD_VALUE_MULTIPLIER,
        );
