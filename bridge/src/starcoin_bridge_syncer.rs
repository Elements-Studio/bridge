...
// Updated tests for the new EventID type system
#[cfg(test)]
mod tests {
    use super::*;
    ...
    async fn test_starcoin_bridge_syncer_basic() -> anyhow::Result<()> {
        ...
        let bridge_package_id = ObjectID::random();
        ...
        let event_2_cursor: EventID = event_2.id.into();
    ...
    fn add_event_response(
        ...
        mock.add_event_response(package, module.clone(), cursor, events.clone());
    }
}
