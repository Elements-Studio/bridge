...
pub struct BridgeMetrics {
    ...
    pub(crate) last_synced_starcoin_bridge_checkpoints: IntGaugeVec,
...
impl BridgeMetrics {
    pub fn new(registry: &Registry) -> Self {
        Self {
            ...
            .unwrap(),
            last_synced_starcoin_bridge_checkpoints: register_int_gauge_vec_with_registry!(
                "bridge_last_synced_starcoin_bridge_checkpoints",
                "The latest starcoin checkpoints synced for each module",
                &["module_name"],
                registry,
            )
            .unwrap(),
