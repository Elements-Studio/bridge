...
use starcoin_bridge_indexer_alt_framework_store_traits::{
...
pub use starcoin_bridge_indexer_alt_framework_store_traits as store;
pub use starcoin_bridge_types as types;
...
mod tests {
    ...
    use std::sync::Arc;
    use starcoin_bridge_synthetic_ingestion::synthetic_ingestion;
    use tokio_util::sync::CancellationToken;
    ...
    impl Processor for MockHandler {
        ...
        fn process(
            &self,
            _checkpoint: &Arc<starcoin_bridge_types::full_checkpoint_content::CheckpointData>,
