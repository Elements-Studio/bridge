...
use starcoin_bridge_indexer_alt_metrics::db::DbConnectionStatsCollector;
...
pub mod tests {
    ...
    use std::sync::Arc;
    use starcoin_bridge_indexer_alt_framework_store_traits::{CommitterWatermark, Store};
    use starcoin_bridge_types::full_checkpoint_content::CheckpointData;
