...
// Impl std::io::Write for HashFunctionWrapper. Needed for compatibility in Starcoin.
...
// EllipticCurveMultisetHash removed for minimal bridge version (requires Ristretto255)
/*
// `EllipticCurveMultisetHash` (ECMH) is a homomorphic multiset hash function.
