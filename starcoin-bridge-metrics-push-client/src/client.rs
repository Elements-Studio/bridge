...
impl MetricsPushClient {
    pub fn new(metrics_key: starcoin_bridge_types::crypto::NetworkKeyPair) -> Self {
        use fastcrypto::traits::KeyPair;
        let certificate = std::sync::Arc::new(starcoin_bridge_tls::SelfSignedCertificate::new(
            metrics_key.private(),
            starcoin_bridge_tls::STARCOIN_VALIDATOR_SERVER_NAME,
        ));
